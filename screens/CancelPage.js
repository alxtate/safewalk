...
export default class CancelPage extends React.Component {
    constructor(props){
        ...
        this.state = {
            userName: 'JS Test',
            userDawgTag: '855580836',
            userEmail: 'alex.troue@siu.edu',
            userPhoneNumber: '6182018435',
        ...
        return (
            ...
            <View style={styles.header}>
                <Text style={styles.description}>
                    In order to request an escort from the Department of Public Safety, you must fill out the form completely and submit it to request a walk escort.
                </Text>
            </View>
